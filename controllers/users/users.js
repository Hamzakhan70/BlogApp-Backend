...
const registerCtrl = async (req, res, next) => {
  ...
  try {
    ...
    //Hash passsword
    const salt = await bcrypt.genSalt(10); // num 10 is recomended bcz higher num will slow-down the program
    //salt is a string
...
//update user --------- it will  only update the email and name of the user for password update we have another route.
